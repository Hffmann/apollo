...
#include "cyber/tools/cyber_carla/info.h"
#include "cyber/tools/cyber_carla/player/player.h"
#include "cyber/tools/cyber_carla/recorder.h"
#include "cyber/tools/cyber_carla/recoverer.h"
#include "cyber/tools/cyber_carla/spliter.h"
...
void DisplayUsage(const std::string& binary, const std::string& command) {
  if (command == "info") {
    std::cout << "usage: cyber_carla info file" << std::endl;
