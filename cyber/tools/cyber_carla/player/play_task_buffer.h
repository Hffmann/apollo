...
#ifndef CYBER_TOOLS_CYBER_CARLA_PLAYER_PLAY_TASK_BUFFER_H_
#define CYBER_TOOLS_CYBER_CARLA_PLAYER_PLAY_TASK_BUFFER_H_
...
#endif  // CYBER_TOOLS_CYBER_CARLA_PLAYER_PLAY_TASK_BUFFER_H_
