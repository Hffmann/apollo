...
#ifndef CYBER_TOOLS_CYBER_CARLA_PLAYER_PLAY_TASK_CONSUMER_H_
#define CYBER_TOOLS_CYBER_CARLA_PLAYER_PLAY_TASK_CONSUMER_H_
...
#endif  // CYBER_TOOLS_CYBER_CARLA_PLAYER_PLAY_TASK_CONSUMER_H_
